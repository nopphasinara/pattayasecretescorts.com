<div id="e_search">
	<form action="<?php echo $fullUrl.$sysLang.'/profiles.html'; ?>" method="get" id="form_search">
		...
		<div class="form_item">
			...
			--><div class="inline">
				<div class="button_submit one inline"><a href="javascript:;" title="" data-type="submit" data-id="form_search"><strong>Chercher</strong></a></div>
			</div>
		</div>
		<div class="form_item">
			<div class="label inline">
			...
			--><div class="inline">
				<div class="button_submit two inline"><a href="javascript:;" title="" data-type="link" class="show_anvance"><strong>Afficher les options avancées</strong></a></div>
			</div>
		</div>
		<div id="advance_option" class="<?php echo $option_hidden; ?>">
			<div class="form_item">
				...
				--><div class="inline">
					<div class="give_space10"><h3><strong>Options avancées:</strong></h3></div>
					<div class="text_yellow give_space10">* Les services sous soumis à une exigence d'hygiène personnelle</div>
							...
							<?php
								...
								if(!$receives) {
									...
									for($i = 0; $i < $total_item; $i++) {
										...
										echo '<div class="give_space5"><input type="checkbox" name="receives[]" value="'.$receives[$i]['id'].'" '.$checked.' /> Accepte: '.$receives[$i]['name_'.$sysLang.''].'</div>';
									}
								}
							?>
						</div><!--
							...
							<?php
								...
								if(!$offers) {
									...
									for($i = 0; $i < $total_item; $i++) {
										...
										echo '<div class="give_space5"><input type="checkbox" name="offers[]" value="'.$offers[$i]['id'].'" '.$checked.' /> Offre: '.$offers[$i]['name_'.$sysLang.''].'</div>';
									}
								}
							?>
						</div>
