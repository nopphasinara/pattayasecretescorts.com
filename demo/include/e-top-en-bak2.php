<div id="e_header">
  ...
  <div id="e_topbar">
    <div class="content_res">
      <div class="box_left">
        <div class="time">
  				<strong><span class="text_yellow"><i class="far fa-clock"></i> Office Hours:</span> Monday - SUNDAY at 12:00 - 22:00</strong>
  			</div>
      </div>
      <div class="box_right">
  ...
  <div id="e_top">
  	<div class="content_res mt-2">
  		...
  		<div class="box">
  			<div class="language d-none d-md-inline-block">
  			...
  			<div class="box-lead oswald d-none d-md-inline-block">
  				<p class="lead">"Discretion And Perfection, A Perfect Harmony"</p>
  			</div>
  		</div>
  		<div class="clear"></div>
  	</div>
