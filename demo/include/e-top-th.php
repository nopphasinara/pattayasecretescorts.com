<div id="e_top">
	<div class="content_res">
		...
		<div class="box">
			<div class="language">
				<div class="label text_yellow"><strong>เลือกภาษาของท่าน</strong></div>
				<div class="icon">
					<?php
						$query_string = ($_SERVER['QUERY_STRING'] == '') ? '' : '?'.$_SERVER['QUERY_STRING'];
						foreach($languageSet as $key => $value) {
							echo '<div class="item inline '.$value.'">
								<a href="'.$fullUrl.$value.'/'.$pageName.'.html'.$query_string.'" title="'.$languageLabel[$value].'"><img src="'.$fullUrl.'image/icon-'.$value.'.png" width="40" height="24" alt="icon-'.$value.'.png" /></a>
							</div>';
						}
					?>
				</div>
			...
			<div class="fix_button big phone oswald">
				...
				--><div class="body inline">
					<a href="javascript:;" title="Call Us Now! <?php echo $sitePhone; ?>">โทร. <span class="text_white"><?php echo $sitePhone; ?></span></a>
				</div><!--
