<div id="e_top">
	<div class="content_res">
		...
		<div class="box">
			<div class="language">
				<div class="label text_yellow"><strong>言語を選択してください</strong></div>
				<div class="icon">
					<?php
			...
			<div class="fix_button big phone oswald">
				...
				--><div class="body inline">
					<a href="javascript:;" title="Call Us Now! <?php echo $sitePhone; ?>">電話 <span class="text_white"><?php echo $sitePhone; ?></span></a>
				</div><!--
