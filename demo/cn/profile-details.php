...
<div id="e_wrapper">
	<div class="content_res">
		...
		<div id="e_content">
				...
				<div class="photos">
					...
					<div class="body">
						<?php
							...
							$db->close();
							if(!$photo) {
								echo '<div class="text_center text_red"><strong>照片是不可用。</strong></div>';
							} else {
			...
			<!--e_option-->
			<div id="e_option">
				<h2 class="title text_yellow give_space15 give_border">高级选项:</h2>
			...
			<div id="e_review">
				<?php
					...
					$db->close();
					if(!$review) {
						echo '<h2 class="title text_yellow give_space15 give_border">评价 (0)</h2>';
						echo '<div class="text_center"><strong>成为第一个撰写评论。</strong></div>';
					} else {
						$total_item = count($review);
						echo '<h2 class="title text_yellow give_space15 give_border">评价 ('.number_format($total_item, 0, '', ',').')</h2>';
						for($i = 0; $i < $total_item; $i++) {
							$star = '';
			...
			<!--e_add_review-->
			<div id="e_add_review">
				<h2 class="title text_yellow give_space15 give_border">添加评价</h2>
						...
						--><div class="inline">
							<div class="button_submit inline fix_button small oswald">
								...
								--><div class="body inline">
									<a href="javascript:;" title="提交" data-type="submit" data-id="form_review" class="text_white">提交</a>
								</div><!--
