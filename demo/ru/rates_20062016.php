	...
	<div class="content_res">
		...
		<div id="e_content">
			...
			<div class="list_rates">
				...
				<div class="item">
					<div class="col col1 inline">3 часа</div><!--
					--><div class="col col2 inline">Множественное окончание</div><!--
					--><div class="col col3 inline">6,500 THB</div>
				</div>
				<div class="item">
					<div class="col col1 inline">4 часа</div><!--
					--><div class="col col2 inline">Множественное окончание</div><!--
				...
				<div class="item">
					<div class="col col1 inline">Уровень А</div><!--
					--><div class="col col2 inline">Дополнительная плата</div><!--
					--><div class="col col3 inline">2,000 THB</div>
				</div>
				<div class="item last">
					<div class="col col1 inline">Пары</div><!--
					--><div class="col col2 inline">Муж/жена</div><!--
					--><div class="col col3 inline">Удвоенные стандартные цены</div>
				</div>
			</div>
