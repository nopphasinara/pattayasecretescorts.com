...
<div id="e_wrapper">
	<div class="content_res">
		...
		<div id="e_content">
					...
					<div class="size">
						<div class="item">
							...
							--><div class="info inline">
								<?php if(empty($data['height'])) { echo '-'; } else { echo $data['height']; } ?> см
							</div>
						</div>
						<div class="item">
							<div class="label inline">
							...
							--><div class="info inline">
								<?php if(empty($data['weight'])) { echo '-'; } else { echo $data['weight']; } ?> кг
							</div>
						</div>
						<div class="item">
							<div class="label inline">
							...
							--><div class="info inline">
								<?php if(empty($data['shoe_size'])) { echo '-'; } else { echo $data['shoe_size']; } ?> (европейский)
							</div>
						</div>
					</div>
					<div class="label">
				...
				<div class="photos">
					...
					<div class="body">
						<?php
							...
							$db->close();
							if(!$photo) {
								echo '<div class="text_center text_red"><strong>Фото не доступно.</strong></div>';
							} else {
			...
			<!--e_option-->
			<div id="e_option">
				<h2 class="title text_yellow give_space15 give_border">ДОПОЛНИТЕЛЬНЫЕ ОПЦИИ:</h2>
			...
			<div id="e_review">
				<?php
					...
					$db->close();
					if(!$review) {
						echo '<h2 class="title text_yellow give_space15 give_border">ОТЗЫВЫ (0)</h2>';
						echo '<div class="text_center"><strong>Оставь отзыв одним из первых.</strong></div>';
					} else {
						$total_item = count($review);
						echo '<h2 class="title text_yellow give_space15 give_border">ОТЗЫВЫ ('.number_format($total_item, 0, '', ',').')</h2>';
						for($i = 0; $i < $total_item; $i++) {
							$star = '';
			...
			<!--e_add_review-->
			<div id="e_add_review">
				<h2 class="title text_yellow give_space15 give_border">ДОБАВИТЬ ОТЗЫВ</h2>
						...
						--><div class="inline">
							<div class="button_submit inline fix_button small oswald">
								...
								--><div class="body inline">
									<a href="javascript:;" title="ОТПРАВИТЬ" data-type="submit" data-id="form_review" class="text_white">ОТПРАВИТЬ</a>
								</div><!--
