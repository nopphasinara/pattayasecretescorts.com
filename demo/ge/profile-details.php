...
<div id="e_wrapper">
	<div class="content_res">
		...
		<div id="e_content">
				...
				<div class="photos">
					...
					<div class="body">
						<?php
							...
							$db->close();
							if(!$photo) {
								echo '<div class="text_center text_red"><strong>Foto ist nicht verfügbar.</strong></div>';
							} else {
			...
			<!--e_option-->
			<div id="e_option">
				<h2 class="title text_yellow give_space15 give_border">Leistungen:</h2>
							...
							for($i = 0; $i < $total_item; $i++) {
								...
								echo '<div class="item">
									...
									--><div class="option inline">
										Nimmt an: '.$receives[$i]['name_'.$sysLang.''].'
									</div>
								</div>';
							}
						}
			...
			<div id="e_review">
				<?php
					...
					$db->close();
					if(!$review) {
						echo '<h2 class="title text_yellow give_space15 give_border">Bewertungen (0)</h2>';
						echo '<div class="text_center"><strong>Seien Sie der erste, der eine Bewertung zu schreiben.</strong></div>';
					} else {
						$total_item = count($review);
						echo '<h2 class="title text_yellow give_space15 give_border">Bewertungen ('.number_format($total_item, 0, '', ',').')</h2>';
						for($i = 0; $i < $total_item; $i++) {
							$star = '';
			...
			<!--e_add_review-->
			<div id="e_add_review">
				<h2 class="title text_yellow give_space15 give_border">Bewertung Hinzufügen</h2>
						...
						--><div class="inline">
							<div class="button_submit inline fix_button small oswald">
								...
								--><div class="body inline">
									<a href="javascript:;" title="Absenden" data-type="submit" data-id="form_review" class="text_white">Absenden</a>
								</div><!--
