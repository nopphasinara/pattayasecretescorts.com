...
<div id="e_wrapper">
	<div class="content_res">
		...
		<!--e_content-->
		<div id="e_content">
			<h1 class="title text_yellow give_space10"><strong>PRENOTAZIONE</strong></h1>
			<h2 class="subtitle text_yellow give_space15">INFORMAZIONI SUL SERVIZIO</h2>
			<p class="text_hint">Per funzionarecorrettamente, questa pagina richiede che JavaScripts sia attivo.</p>
			<div>&nbsp;</div><div>&nbsp;</div>
			...
			<form action="<?php echo $fullUrl.$sysLang.'/booking-action.html'; ?>" method="post" id="form_add">
				...
				<div class="form_item">
					<div class="label inline">
						Servizio richiesto: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Seleziona escort: <strong>*</strong>
					</div>
				</div>
				<div class="form_item">
					<div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Giorno dell’appuntamento: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Orario dell’appuntamento: <strong>*</strong>
					</div><!--
				...
				<div>&nbsp;</div><div>&nbsp;</div>
				<h2 class="subtitle text_yellow give_space15">DATI PERSONALI</h2>
				<p>Campi contrassegnati = <strong class="text_yellow">Obbligatori</strong>, Indirizzo = <strong class="text_yellow">se conosciuto</strong></p>
				<div>&nbsp;</div>
				<div class="form_item">
					<div class="label inline">
						Sono: <strong>*</strong>
				...
				<div class="form_item">
					<div class="label inline">
						Numero di telefono: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Numero di camera: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Come preferisci essere contattato?: <strong>*</strong>
					</div><!--
					--><div class="inline">
					...
					--><div class="inline">
						<div class="button_submit inline fix_button small oswald">
							...
							--><div class="body inline">
								<a href="javascript:;" title="INVIA" data-type="submit" data-id="form_add" class="text_white">INVIA</a>
							</div><!--
