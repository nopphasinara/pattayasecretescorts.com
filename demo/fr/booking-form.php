...
<div id="e_wrapper">
	<div class="content_res">
		...
		<!--e_content-->
		<div id="e_content">
			<h1 class="title text_yellow give_space10"><strong>RÉSERVATION</strong></h1>
			<h2 class="subtitle text_yellow give_space15">INFORMATIONS SUR LES SERVICES</h2>
			<p class="text_hint">JavaScript doit être activé pour que cette page fonctionne correctement.</p>
			<div>&nbsp;</div><div>&nbsp;</div>
			...
			<form action="<?php echo $fullUrl.$sysLang.'/booking-action.html'; ?>" method="post" id="form_add">
				...
				<div class="form_item">
					<div class="label inline">
						Date du rendez-vous: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Heure du rendez-vous: <strong>*</strong>
					</div><!--
				...
				<div>&nbsp;</div><div>&nbsp;</div>
				<h2 class="subtitle text_yellow give_space15">INFORMATIONS PERSONNELLES</h2>
				<p>* = <strong class="text_yellow">champ requis</strong>, Adresse = <strong class="text_yellow">si connue</strong></p>
				<div>&nbsp;</div>
				<div class="form_item">
					<div class="label inline">
						Je suis: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Numéro de chambre: <strong>*</strong>
					</div><!--
					--><div class="inline">
				...
				<div class="form_item">
					<div class="label inline">
						Comment vous contacter: <strong>*</strong>
					</div><!--
					--><div class="inline">
					...
					--><div class="inline">
						<div class="button_submit inline fix_button small oswald">
							...
							--><div class="body inline">
								<a href="javascript:;" title="Submit" data-type="submit" data-id="form_add" class="text_white">ENVOYER</a>
							</div><!--
