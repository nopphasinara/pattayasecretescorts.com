...
<div id="e_wrapper">
	<div class="content_res">
		...
		<div id="e_content">
			...
			<div id="e_profile">
				<div class="details">
					...
					<div class="size">
						...
						<div class="item">
							<div class="label inline">
								<strong>Taille de chaussures:</strong>
							</div><!--
							--><div class="info inline">
			...
			<!--e_option-->
			<div id="e_option">
				<h2 class="title text_yellow give_space15 give_border">Options avancées:</h2>
							...
							for($i = 0; $i < $total_item; $i++) {
								...
								echo '<div class="item">
									...
									--><div class="option inline">
										Accepte: '.$receives[$i]['name_'.$sysLang.''].'
									</div>
								</div>';
							}
						}
			...
			<div id="e_review">
				<?php
					...
					$db->close();
					if(!$review) {
						echo '<h2 class="title text_yellow give_space15 give_border">COMMENTAIRES (0)</h2>';
						echo '<div class="text_center"><strong>Soyez le premier à écrire un avis.</strong></div>';
					} else {
						$total_item = count($review);
						echo '<h2 class="title text_yellow give_space15 give_border">COMMENTAIRES ('.number_format($total_item, 0, '', ',').')</h2>';
						for($i = 0; $i < $total_item; $i++) {
							$star = '';
			...
			<!--e_add_review-->
			<div id="e_add_review">
				<h2 class="title text_yellow give_space15 give_border">AJOUTER COMMENTAIRES</h2>
						...
						--><div class="inline">
							<div class="button_submit inline fix_button small oswald">
								...
								--><div class="body inline">
									<a href="javascript:;" title="Submit" data-type="submit" data-id="form_review" class="text_white">ENVOYER</a>
								</div><!--
