...
<div id="e_wrapper">
	<div class="content_res">
		...
		<!--e_content-->
		<div id="e_content">
			<h1 class="title text_yellow give_space10"><strong>예약</strong></h1>
			<h2 class="subtitle text_yellow give_space15">서비스 정보</h2>
			<p class="text_hint">이 페이지는 자바스크립이 필요합니다.</p>
			<div>&nbsp;</div><div>&nbsp;</div>
			...
			<form action="<?php echo $fullUrl.$sysLang.'/booking-action.html'; ?>" method="post" id="form_add">
				...
				<div>&nbsp;</div><div>&nbsp;</div>
				<h2 class="subtitle text_yellow give_space15">개인정보</h2>
				<p>스타목록 = <strong class="text_yellow">기입필수</strong>, 주소 = <strong class="text_yellow">알려진 대로</strong></p>
				<div>&nbsp;</div>
				<div class="form_item">
					<div class="label inline">
						저는: <strong>*</strong>
				...
				<div class="form_item">
					<div class="label inline">
						어떻게 저희가 연락하기를 원하십니까?: <strong>*</strong>
					</div><!--
					--><div class="inline">
					...
					--><div class="inline">
						<div class="button_submit inline fix_button small oswald">
							...
							--><div class="body inline">
								<a href="javascript:;" title="제출" data-type="submit" data-id="form_add" class="text_white">제출</a>
							</div><!--
