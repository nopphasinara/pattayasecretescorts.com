            ...
            <div class="col-12">
              ...
              <div class="row mb-4">
                <div class="col-12">
                  ...
                  <?php
                  $check_icon = '<i class="fas fa-check-circle text-success"></i>';
                  $uncheck_icon = '<i class="fas fa-times-circle text-danger"></i>';
                      ...
                      <div class="col-12">
                        ...
                        <div class="row">
                          ...
                          for($i = 0; $i < $total_item; $i++) {
                            ...
                            $checked_service = $mw->checkService($data['id'], $receives[$i]['id']) == 'checked' ? $check_icon : $uncheck_icon;
                            ?>
                  ...
                  <?php
                  $db->connect();
                  $offers = $db->select("SELECT * FROM sw_services WHERE status = 'enable' AND offers = 'yes' ORDER BY name_".$sysLang." ASC");
                  $db->close();
                  if($offers) {
                    ?>
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="row">
                          ...
                          for($i = 0; $i < $total_item; $i++) {
                            ...
                            $checked_service = $mw->checkService($data['id'], $offers[$i]['id']) == 'checked' ? $check_icon : $uncheck_icon;
                            ?>
                            <div class="col-12 col-sm-6 col-md-4">
                              <?php echo $checked_service .' '. $offers[$i]['name_'.$sysLang.'']; ?>
                            </div>
                            <?php
                          }
                          ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-8 mb-4 mb-md-0">
              ...
              if(!$reviews) {
                ?>
                <h3 class="text-primary text-uppercase mb-3"><strong>Reviews <span class="badge badge-warning ml-2 text-md"><?php echo number_format($total_item, 0, '', '.'); ?></span></strong></h3>
                <p class="text-center">
                ...
                ?><h3 class="text-primary text-uppercase mb-3"><strong>Reviews <span class="badge badge-warning ml-2 text-md"><?php echo number_format($total_item, 0, '', '.'); ?></span></strong></h3><?php
                for($i = 0; $i < $total_item; $i++) {
                  $star = '';
